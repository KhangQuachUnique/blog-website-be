...
export class CommunitySettingResponseDto {
    ...
    @Expose()
    @ApiProperty( { example: 'A community for technology lovers', description: 'Community Description' } )
    description: string;

    @Expose()
    @ApiProperty( { example: 'https://example.com/thumbnail.jpg', description: 'Community Thumbnail URL' } )
    thumbnailUrl: string;
